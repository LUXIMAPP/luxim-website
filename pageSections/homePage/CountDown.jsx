...
const CountDown = () => (
  <>
    <Box bg="brand.primary1" display="flex" alignItems="center" justifyContent="space-between" py={9} marginBottom={-20}>
      <Wrapper>
        <Box>
    ...
    <Box display="flex" justifyContent="right" position="relative" top="-153" zIndex={0}>
