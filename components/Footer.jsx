...
const Footer = ({ isFloatingCardExist }) => {
  ...
  return (
    <Box
      bg="brand.primary1"
      pb={{ base: 10, lg: 16 }}
      pt={isFloatingCardExist ? { base: 16, lg: 40 } : { base: 10, lg: 16 }}
      id="contact"
    >
      <Wrapper>
        <Box
              ...
              {[
                ...
                <ListItem key={item.title}>
                  <Link href={`${item.link}`}>
                    <a
                      className={`${
                        router.asPath === item.link ? 'text-[#D3DB22]' : ''
                      } hover:text-[#D3DB22]`}
                    >
                      {item.title}
                    </a>
        ...
        <Box pt={8}>
          <Box
            ...
            pb={4}
          >
            <Text color="brand.lemon" fontSize={{ base: '14px', lg: '16px' }}>
            ...
            <Box display="flex" gap={4}>
              {[
                {
                  logo: facebook,
                  link: 'https://www.facebook.com/luximapp',
                  alt: 'Facebook icon logo',
                },
                {
                  logo: twitter,
                  link: 'https://twitter.com/LuximApp',
                  alt: 'Twitter icon logo',
                },
                {
                  logo: instagram,
                  link: 'https://www.instagram.com/luximapp/',
                  alt: 'Instagram icon logo',
                },
                {
                  logo: linkedin,
                  link: 'https://www.linkedin.com/company/luxim/',
                  alt: 'LinkedIn icon logo',
                },
                {
                  logo: tiktok,
                  link: 'https://www.tiktok.com/@luximapp?_t=8fF5PLbbi50&_r=1',
                  alt: 'Tiktok icon logo',
                },
                {
                  logo: youtube,
                  link: 'https://youtube.com/@LuximApp?si=lAE7Kt8dcGZrQHPP',
                  alt: 'YouTube icon logo',
                },
              ].map((item) => (
                <a
                  key={item.alt}
