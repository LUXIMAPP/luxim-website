    ...
    <Box width="50%">
      <Box width="70%" textAlign="start">
        ...
        <Text fontSize="36px" fontWeight="700" lineHeight="48px" mb={6}>
          Virtual marketplace of pre-owned traditional fashion wears — no startup
          costs
        </Text>
        <Text fontWeight="500" color="brand.grey" lineHeight="28px" mb={16}>
          ...
          providing sellers with a platform to reach a broad audience of customers
        </Text>
        <Box display="flex" gap={4}>
          <Input placeholder="Enter your email" fontSize="sm" />
          <AppButton theme="brand.primary1" title="Join Waitlist" color="white" />
        </Box>
      </Box>
    </Box>
    <Box width="50%">
