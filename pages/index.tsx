    ...
    <div className="flex justify-center text-center">
      <div>
        ...
        <h3 className="tracking-wider font-light leading-normal">
          by
          {' '}
          <a href="https://github.com/enyata" className="underline italic" target="_blank" rel="noopener noreferrer">Enyata</a>
        </h3>
        <div className="m-8">
          <a href="https://github.com/enyata/enyata-next-base" className="underline text-red-900">
            Repo
          </a>
        </div>
      </div>
