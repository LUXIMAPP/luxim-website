const textFile = [
  {
    ...
    text: [
      'These Terms and Conditions constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and LuximApp Limited (“we,” “us” or “our”), concerning your access to and use of the luximapp.com website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”).',
    ...
    sections: [
      {
        ...
        bulletPoints: [
          ...
          'That prevent or restrict the use or copying of any Content or enforce limitations on the use of the Site. And/or the Content contained therein. Engage in unauthorised framing of or linking to the Site.',
    ...
    sections: [
      {
        ...
        bulletPoints: [
          ...
          'ou have the written consent, release, and/or permission of each and every identifiable individual person in your Contributions to use the name or likeness of each and every such identifiable individual person.',
          'To enable inclusion and use of your Contributions in any manner contemplated by the Site and these Terms and Conditions.',
          ...
          'our Contributions do not violate any federal or state law concerning child pornography, or otherwise intended to protect the health or well-being of minors.',
      ...
      {
        text: ['Any use of the Site in violation of the foregoing violates these Terms and Conditions and may result in, among other things, termination or suspension of your rights to use the Site.'],
        bulletPoints: [],
        subTitle: '',
        bulletHeading: '',
      },
  ...
  },
  {
    ...
    text: [
      ...
      'You are solely responsible for your Contributions to the Site and you expressly agree to exonerate us from any and all responsibility and to refrain from any legal action against us regarding your Contributions. We have the right, in our sole and absolute discretion, (1) to edit, redact, or otherwise change any Contributions; (2) to re-categorize any Contributions to place them in more appropriate locations on the Site; and (3) to pre-screen or delete any Contributions at any time and for any reason, without notice. We have no obligation to monitor your Contributions.',
    ],
    sections: [],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        subTitle: 'Apple and Android Devices',
        text: ['The following terms apply when you use a mobile application obtained from either the Apple Store or Google Play (each an “App Distributor”) to access the Site:'],
        bulletHeading: '',
        bulletPoints: [
          ...
          'You represent and warrant that (i) you are not located in a country that is subject to a U.S. or Nigerian government embargo, or that has been designated by the U.S. or Nigerian government as a “terrorist supporting” country and (ii) you are not listed on any U.S. or Nigerian government list of prohibited or restricted parties',
    ...
    sections: [
      {
        ...
        bulletPoints: [
          ...
          'ake appropriate legal action against anyone who, in our sole discretion, violates the law or these Terms and Conditions, including without limitation, reporting such user to law enforcement authorities',
  ...
  },
  {
    ...
    text: [
      'We care about data privacy and security. Please review our Privacy Policy <a href="http://luximapp.com/privacy-policy/" target="_blank">(here)</a>. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms and Conditions.',
    ],
    sections: [],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bulletHeading: 'Counter Notification',
        subTitle: '',
        bulletPoints: [
      ...
      },
      {
        text: [
          ...
          'Luxim App Ltd. Support Services',
          'Attn: Copyright Agent',
          '32/34 Opebi Rd Ikeja, Lagos, Nigeria',
          'support@luximapp.com',
        ],
        bulletHeading: '',
        subTitle: '',
        bulletPoints: [],
  ...
  },
  {
    title: 'GOVERNING LAW',
    text: [
      'These Terms and Conditions and your use of the Site are governed by and construed in accordance with the laws of the State of Lagos applicable to agreements made and to be entirely performed within the nation of Nigeria, without regard to its conflict of law principles.',
    ],
    sections: [],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        text: [
          ...
          'The arbitration may be conducted in person, through the submission of documents, by phone, or online. The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party. The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so. Except where otherwise required by the applicable rules or applicable law, the arbitration will take place in Lagos, Nigeria.',
          ...
          'If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in Lagos, Nigeria, and the Parties hereby consent to, and waive all defences of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Terms and Conditions. ',
          'In no event shall any Dispute brought by either Party related in any way to the Site be commenced more than two years after the cause of action arose. If this provision is found to be illegal or unenforceable, then neither Party will elect to arbitrate any Dispute falling within that portion of this provision found to be illegal or unenforceable and such Dispute shall be decided by a court of competent jurisdiction within the courts listed for jurisdiction above, and the Parties agree to submit to the personal jurisdiction of that court.',
        ],
        bulletHeading: '',
        bulletPoints: [],
      },
      ...
      {
        subTitle: 'Exceptions to [Informal Negotiations and] Arbitration',
        bulletHeading: '',
        text: [
    ...
    sections: [
      {
        ...
        text: [
          ...
          '32/34 Opebi Rd',
          'Ikeja, Lagos, Nigeria',
          '<a href="mailto:hello@luximapp.com">support@luximapp.com</a>',
        ],
      },
    ],
  },
